...
//
  ...
  String selectedExperience = ''; // 0 represents no selection
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  selectedExperience == ''
                      ? 'All Donors'
                      : 'Donors with $selectedExperience blood group',
                  style: const TextStyle(
              ...
              StreamBuilder(
                  stream: selectedExperience == ''
                      ...
                      : FirebaseFirestore.instance
                          .collection('donors')
                          .orderBy('username')
                          .where('category', isEqualTo: selectedExperience)
                          .startAt([searchText.toUpperCase()]).endAt(
                              ['$searchText\uf8ff']).snapshots(),
                  builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      ...
                      return  Center(
                        ...
                        child: Text(
                          'No donors Registered yet with $selectedExperience ',
                          style: const TextStyle(
                              fontSize: 18,
